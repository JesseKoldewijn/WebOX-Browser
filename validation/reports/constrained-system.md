...
- The generated harness output should distinguish constrained-memory outcomes from compatibility or engine failures.
...
- Confirm recovery-oriented diagnostics and fallback attribution notes remain available for post-run analysis.
